...
def main():
    ...
    log_names = ("2048-2023-04-05-01-40-03.log", "2048-2023-04-05-01-40-07.log", "2048-2023-04-05-01-45-04.log")
    figures_dir_path = lab_dir_path / "figures"
    figure_name = "2048-comparasion.png"
    ...
    for i, log_name in enumerate(log_names):
        ...
        plt.plot(df["episode"], df["mean"], label=f"{i+1}_mean")
        plt.plot(df["episode"], df["max"], label=f"{i+1}_max")
